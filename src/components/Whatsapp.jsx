    ...
    return (
        <>
            ...
            <animated.div
                ...
                className={`fixed bottom-8 right-8 z-0 p-2 rounded-full cursor-pointer transition-transform duration-300 w-16 h-16 items-center justify-center flex
            ...
            {isOpen ? (
                <animated.div
                    style={chatAnimation}
                    className={`fixed bottom-24 right-8 bg-white text-white rounded shadow-lg transition-transform duration-300 z-0`}
                >
