        ...
        <div className='w-[90%] flex flex-col gap-y-12 mx-auto py-10'>
            ...
            <section>
                ...
                >
                    ...
                    <SwiperSlide className='h-96'>Slide 2</SwiperSlide>
                    <SwiperSlide className='h-96'>Slide 3</SwiperSlide>
                    <SwiperSlide className='h-96'>Slide 4</SwiperSlide>
                    <SwiperSlide className='h-96'>Slide 5</SwiperSlide>
                    <SwiperSlide className='h-96'>Slide 6</SwiperSlide>
                    <SwiperSlide className='h-96'>Slide 7</SwiperSlide>
                    <SwiperSlide className='h-96'>Slide 8</SwiperSlide>
                    <SwiperSlide className='h-96'>Slide 9</SwiperSlide>
                </Swiper>
            </section>
